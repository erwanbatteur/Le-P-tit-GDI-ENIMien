...
__copyright__ = "Copyright 08/2022"
__credits__ = [""]
__version__ = "0.1.7"
...
"""
TODO :
- ECROU VIS ??????? (+ serrage vis trois icone en haut de la page ??)
- Faire page Calcul roulements
- Faire page Ajustements
- Faire page Cisaillement ATTENTION ca sera de la RDM avec une autre page
- Faire page Joints

- Changer image Surface/volume (image prete)
- Regler bug calcul triangle (deux distance => angles)
- Changer icone triangle !!!!!!!!!!! (changer nom)
- Changer icone circlips !!!!!!!!!!! (changer nom)
- RESTYLER l'interface d'accueuil

- ajouter serrage Vis ??
- ajouter couple max Clavette / Cannelure
- ajouter aire et perimetre Triangle

- Ajouter la surprise ??
- Version anglaise ?? --- une V2 ??
...
def MENU_Setup():
    ...
    MainCanvas.create_image(XConversionMenu, YConversionMenu, anchor=NW, image = ImgCroRou)#ImgConversions)
...
def Vis_Page_Setup():
    global Menu_deroulant_taille_vis, VisWindowActif
    ...
    global labelDiaTeteCHC, labelDimTeteH, labelHauteurTeteH, labelPasVis, labelPasDV
    VisWindowActif = True
    ...
    labelPasDV = tk.Label(MainCanvas, text = "Pas :", bg="white")
    ...
    labelPasVis.place(x = 40, y = 50)
    # RAJOUTER section vis (utilisable)
    # Bouton cisaillement/traction vis
...
def ClearAllWindowContent():
    global MenuActif, VisWindowActif, ClavetteWindowActif, TriangleWindowActif, CirclipsWindowActive, CalculsGeomWindowActive
...
try:
    ...
    ImgConversions = PhotoImage(file="data/menu/Conversion.png")
